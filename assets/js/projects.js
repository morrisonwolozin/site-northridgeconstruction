...
export const projects = [
  {
    ...
    year: 2026,
    location: 'Camden, ME',
    conditioned_area: 1000,
    bedrooms: 1,
    bathrooms: 1,
    featured: true,
    drawing: 'assets/img/portfolio/modern-bungalow-camden-hero.webp',
  ...
  },
  {
    ...
    bathrooms: 1,
    featured: false,
    drawing: 'assets/img/portfolio/modern-bungalow-phillips-hero.webp',
    delivery_url: null,
    gallery: [    
  ...
  },
  {
    ...
    year: 2024,
    location: 'Belfast, ME',
    conditioned_area: 2275,
    bedrooms: 3,
    bathrooms: 2.5,
    featured: true,
    drawing: 'assets/img/portfolio/greek-revival-belfast-hero-bw.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/modern-colonial-liberty-hero-bw.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    year: 2024,
    location: 'Union, ME',
    conditioned_area: 1485,
    bedrooms: 2,
    bathrooms: 2,
    featured: false,
    drawing: 'assets/img/portfolio/modern-aframe-lincolnville-hero.webp',
    delivery_url: './delivery/05-aframe-union-estimate.html',
    gallery: [
  ...
  },
  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/modern-bungalow-swanville-hero.webp',
    delivery_url: null,
    gallery: [
...

  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/pool-enclosure-camden-hero.webp',
    delivery_url: null,
    gallery: [ 
  ...
  },
  {
    ...
    bathrooms: 2,
    featured: true,
    drawing: 'assets/img/portfolio/modern-ranch-lincolnville-hero.webp',
    delivery_url: './delivery/08-modern-ranch-lincolnville-estimate.html',
    gallery: [
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-00.webp', caption: 'south elevation' },
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-01.webp', caption: 'east elevation' },
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-02.webp', caption: 'living room' },
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-03.webp', caption: 'kitchen' },
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-04.webp', caption: 'screen porch' },
      { src: 'assets/img/portfolio/modern-ranch-lincolnville-05.webp', caption: 'office above garage' },
    ],
  },
  {
    id: 9,
    ...
    year: 2022,
    location: 'Lincolnville, ME',
        conditioned_area: 2180,
    bedrooms: 4,
    bathrooms: 3,
    featured: false,
    drawing: 'assets/img/portfolio/modern-bungalow-adu-lincolnville-2-hero-bw.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/sauna-camden-hero.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    year: 2020,
    location: 'Lincolnville, ME',
    conditioned_area: 950,
    bedrooms: 1,
    bathrooms: 1,
    featured: false,
    drawing: 'assets/img/portfolio/modern-bungalow-adu-lincolnville-1-hero.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    year: 2021,
    location: 'Lincolnville, ME',
    conditioned_area: 3750,
    bedrooms: 3,
    bathrooms: 2.5,
    featured: true,
    drawing: 'assets/img/portfolio/modern-colonial-lincolnville-hero-bw.webp',
    delivery_url: null,
    gallery: [
...

  {
    id: 13,
    priority: 9,
    name: 'Duplex Renovation & Additions',
    type: 'renovation',
    status: 'completed',
    year: 2025,
    location: 'Belfast, ME',
    conditioned_area: 1850,
    bedrooms: 4,
    bathrooms: 3,
    featured: false,
    drawing: 'assets/img/portfolio/renovation-addition-belfast-hero-bw.webp',
    delivery_url: null,
    gallery: [ 
...

  {
    ...
    year: 2019,
    location: 'Palermo, ME',
    conditioned_area: 1950,
    bedrooms: 3,
    bathrooms: 4,
    featured: false,
    drawing: 'assets/img/portfolio/modern-barn-palermo-hero.webp',
    delivery_url: null,
    gallery: [
...

  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/modern-barn-somerville-hero.webp',
    delivery_url: null,
    gallery: [
...

  {
    ...
    conditioned_area: 1330,
    bedrooms: 2,
    bathrooms: 2,
    featured: false,
    drawing: 'assets/img/portfolio/modern-cottage-northport-hero.webp',
    delivery_url: null,
    gallery: [
...

  {
    ...
    bathrooms: null,
    featured: false,
    drawing: 'assets/img/portfolio/renovation-addition-liberty-hero.webp',
    delivery_url: null,
    gallery: [
  ...
  },
  {
    ...
    status: 'current',
    year: 2026,
    location: 'S. Thomaston, ME',
    conditioned_area: 820,
    bedrooms: 1,
    bathrooms: 1,
    featured: true,
    drawing: 'assets/img/portfolio/modern-cottage-south-thomaston-hero.webp',
